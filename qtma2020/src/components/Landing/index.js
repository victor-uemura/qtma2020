		...
		<div className='landing-body'>
			...
			<div className='landing-top'>
				...
				<div className='landing-p1'>
					Voluntera understands that different people want to create a
					social impact in different ways. All of our partner
					organizations accept donations of both time and money.
				</div>
				...
				<div className='h-middle-box'>
					...
					<div className='v-middle-box'>
						...
						<p className='landing-p2'>
							Volunterra is a registered charity in the province
							of Ontario. You can trust that we’re committed to
				...
				<div className='left-title'>
					<p className='landing-p3'>
						Our partner organizations are selected after months of
						research to check for credibility, trust, and true need.
						We curate these opportunities to best match your
						profile.
					</p>
				</div>
				<img
				...
				<div className='h-middle-box2'>
					...
					<p className='landing-p4'>
						For every donation, or time commitment, Voluntera will
						further your contributions by continuing to support the
						organization.
					</p>
				</div>
				<div className='h-middle-box3'>
					...
					<div className='v-middle-box2'>
						...
						<div className='landing-p5'>
							Apply to volunteer at select local charities chosen
							by our team.
						</div>
						<div className='landing-subtitle3'>Donate money</div>
						<div className='landing-p6'>
							Not enough time? You can donate money towards
							organizations too.
						</div>
					</div>
				</div>
