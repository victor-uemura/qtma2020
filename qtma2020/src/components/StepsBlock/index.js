	...
	return <div>
			...
			<div class="container">
				...
				<div className="step-impact">
					One donation with Voluntera can make a bigger impact than you think
				</div>
		
					<div class="grid2">
						<img src="magnifying_glass.svg" alt="magnifying glass" class="center"></img>
						<img src="coins.svg" alt="coins" class="center"></img>
						<img src="leaf.svg" alt="leaf" class="center"></img>
						...
						<div className="step-title"><b>
							Choose an Organization</b>
						</div>
						<div className="step-title"><b>
							Donate money</b>
						</div>
						<div className="step-title"><b>
							Amplify your impact</b>
						</div>
						...
						<div className="step-explain">
							For every $5 donated, a local Kingston student will do 1 hour of volunteer work
						</div>
					</div>
					</div>
		</div>
