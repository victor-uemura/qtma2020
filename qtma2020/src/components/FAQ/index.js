  ...
  return (
    <div className="faq-body">
      ...
      <div className="faq-answer">
        Voluntera currently partners with local Kingston-based organizations and
        nonprofits. If you have a local organization who would benefit from
        Voluntera let us know!
      </div>
      <div className="faq-question">
        Are there requirements to be a volunteer?
      </div>
      <div className="faq-answer">
        Any requirements will be outlined by the specific organization you chose
        to volunteer with. At Voluntera we simply ask for your commitment as a
      ...
      <div className="faq-answer">
        ...
        guidelines. Many of our partner organizations offer virtual volunteering
        opportunities. Specific information regarding each opportunity is
        outlined under the posting.
      </div>
      <div className="faq-question">
      ...
      <div className="faq-answer">
        ...
        automatically forward your information to the volunteering opportunities
        you apply for. Certain opportunities/organizations may specify
